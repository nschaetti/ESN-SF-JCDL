...
if __name__ == "__main__":
    ...
    # Argument parser
    parser = argparse.ArgumentParser(description="ESN-SF-JCDL - Create dataset")
    ...
    for author_name in os.listdir(args.input):
        # Author directory
        author_path = os.path.join(args.input, author_name)
